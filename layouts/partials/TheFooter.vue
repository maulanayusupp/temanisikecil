<template>
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8" v-if="false">
        <div>
      ...
      <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between" v-if="false">
        <div>
        ...
        <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; 2025 Worksheet Edukatif untuk Anak | Aktivitas & Coding. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/temanisikecil',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
